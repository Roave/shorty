...
exports.server = function(config) {
    ...
    self.connectionListener = function(incomingSocket) {
        ...
        myClient = client.fromSocket(incomingSocket);
        myClient.socket.on('data', self.serverDataHandler);
        myClient.socket.on('end', self.socketCloseHandler);
    ...
    self.socketCloseHandler = function() {
        ...
        closingConnection = self.clients[ this.fd ];
