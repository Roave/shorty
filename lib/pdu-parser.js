...
exports.parse = function(buffer) {
    ...
    if (smpp.command_formats[smpp.command_ids[command_id]] === undefined) {
        throw "command not supported";
    }

    format = smpp.command_formats[smpp.command_ids[command_id]];
    ...
    for (var i = 0; i < format.body.length; i++) {
        ...
        if (field.type == "int") {
            ...
            if (field.length === undefined) {
                ...
                if (buffer[offset] === 0x0) {
                    ...
                    offset += 1;
                     ...
                     buffer.copy(temp, 0, offset, field.length);
            ...
            length = result[field.length_field];
...
var sms = Sms.create("15551231234", "15553214321", "test", 5);
exports.parse(sms.toPdu(smpp.commands.submit_sm).toBuffer());
