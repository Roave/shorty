...
for (const commandId in exports.command_ids) {
    if ({}.hasOwnProperty.call(exports.command_ids, commandId)) {
        exports.commands[exports.command_ids[commandId]] = parseInt(commandId, 10);
    }
}
...
exports.command_formats = {
    ...
    unbind: {
        ...
        allowedStates: [
            exports.sessionStates.OPEN,
            exports.sessionStates.BOUND_RX,
            exports.sessionStates.BOUND_TRX,
            exports.sessionStates.BOUND_TX,
        ],
        serverCanSend: true,
        clientCanSend: true,
    },
...
for (const paramName in exports.optional_params) {
    if ({}.hasOwnProperty.call(exports.optional_params, paramName)) {
        exports.optional_param_tags[exports.optional_params[paramName].tag] = paramName;
    }
}
