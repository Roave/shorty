...
exports.fromPdu = function(myPdu) {
    ...
    if (data_coding == 8) {
        ucs2Message = myPdu.pdu_body.toString('ucs2', i, i + length);
        iconv = new Iconv('UCS-2', 'UTF-8//TRANLIT//IGNORE');
        message = iconv.convert(new Buffer(ucs2Message)).toString('utf8');
    } else {
