...
exports.fromPdu = function(myPdu) {
    from = myPdu.pdu_body.toString('ascii', 3, 14);
    to = myPdu.pdu_body.toString('ascii', 17, 28);
    length = myPdu.pdu_body[38];
    message = myPdu.pdu_body.toString('ascii', 39, myPdu.pdu_body.length);
