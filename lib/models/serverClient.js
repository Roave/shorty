...
var serverClient = function(socket, server, closeConnectionServerCallback, callbacks) {
    ...
    self.deliverMessage = function(sender, recipient, message, user_ref) {
        self.deliver_sm(sender, recipient, message, user_ref);
    };
    ...
    self.deliver_sm = function(sender, recipient, message, user_ref) {
        self.sequence_number++;
        var mySms = sms.create(sender, recipient, message, self.sequence_number, user_ref);
