...
var pdu  = require('./models/pdu'),
    pack = require('./models/utils/pack'),
...
exports.unbind = function(sequence_number) {
    return pdu.createPdu(exports.commands.unbind, sequence_number, null, 0x0);
};

exports.unbind_resp = function(sequence_number) {
    return pdu.createPdu(exports.commands.unbind_resp, sequence_number, null, 0x0);
};
...
exports.submit_sm_resp = function(sequence_number, message_id, cmd_status) {
    ...
    payload = pack.pack('a' + (message_id.length + 1), message_id);
...
exports.bind_resp = function(bind_type, sequence_number, system_id, error_status) {
    ...
    // if you omit them.
    var payload = pack.pack('a' + (system_id.length + 1), system_id),
        cmd_status,
        command_id;
    ...
    if (error_status !== undefined && error_status === true) {
        ...
        cmd_status = 0x0000000E;
    } else {
        cmd_status = 0x0;
    }

    if (bind_type === exports.commands.bind_receiver) {
        command_id = exports.commands.bind_receiver_resp;
    } else if (bind_type === exports.commands.bind_transmitter) {
        command_id = exports.commands.bind_transmitter_resp;
    } else if (bind_type === exports.commands.bind_transceiver) {
        command_id = exports.commands.bind_transceiver_resp;
    }
...
exports.deliver_sm = function(mySms, optional_params) {
    ...
    return mySms.toPdu(smpp.commands.deliver_sm, false);
};
 ...
 * optional params should be an object of the form { param: value }
 */
exports.submit_sm = function(mySms, optional_params, convert) {
    if (optional_params !== undefined) {}
    return mySms.toPdu(smpp.commands.submit_sm, convert);
};
