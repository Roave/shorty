...
exports.bind_transceiver = function(config, sequence_number) {
    ...
    pdu = exports.createPdu(0x00000009, sequence_number, payload);
    return pdu;
}
...
exports.enquire_link_resp = function(sequence_number) {
    return exports.createPdu(0x80000015, sequence_number);
}
...
exports.deliver_sm_resp = function(sequence_number) {
    ...
    // to submit_sm_resp?
    payload = exports.pack('C', "\0");
    return exports.createPdu(0x80000005, sequence_number, payload);
}
 ...
 */
exports.sm_submit = function(from, to, message, sequence_number, optional_params) {
    ...
    pdu = exports.createPdu(0x00000004, sequence_number, payload);
    return pdu;
}
...
/*
 *  These are helper methods that work to support the methods that
 *  implement SMPP commands. They really aren't that useful to the
 *  client or server on their own.
 */
