...
// @TODO investigate potential bug. require() was used here, hinting that shorty is intended to have several instances
// while node modules are shared
exports.getPduParser = function getPduParser() {
    return pduParser;
};

exports.getPduWriter = function getPduWriter() {
    return pduWriter;
};
