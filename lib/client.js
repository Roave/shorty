...
exports.client = function(config) {
    ...
    self.sm_submit = function(from, to, message) {
        ...
        pdu = smpp.createPdu(0x00000004, self.sequence_number, payload);
        self.sendPdu(pdu);
    ...
    self.deliver_sm_resp = function(pdu) {
        ...
        payload = smpp.pack('C', "\0");
        pdu = smpp.createPdu(0x80000005, body['sequence_number'], payload);
        self.sendPdu(pdu);
    ...
    self.enquire_link_resp = function(oldpdu) {
        ...
        pdu = smpp.createPdu(0x80000015, oldpdu['sequence_number']);
        self.sendPdu(pdu);
    };
    ...
    self.bind = function() {
        ...
        pdu = smpp.createPdu(0x00000009, self.sequence_number, payload);
        self.sendPdu(pdu);
    };
