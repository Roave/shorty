 ...
 */
var shortyClients = shorty.createMultiClient('config.json');

function initialize(shortyClient) {
...
var sighandle = function() {
  process.stdin.end();
  for (var i = 0; i < shortyClients.length; i++) {
    shortyClients[i].unbind();
  }
};
